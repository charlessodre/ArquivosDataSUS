...
{
    public class ArquivosRJDataSUS : BaseAquivosDataSUS
    {
        public ArquivosRJDataSUS(string servidorFTP, string usuarioFTP, string senhaFTP, string diretorioFTPArquivos, string diretorioDestinoDownload, string diretorioDestinoDBF, string estado)
            : base(servidorFTP, usuarioFTP, senhaFTP,diretorioFTPArquivos, diretorioDestinoDownload, diretorioDestinoDBF, estado, Constantes.TipoArquivoRJ)
        {
